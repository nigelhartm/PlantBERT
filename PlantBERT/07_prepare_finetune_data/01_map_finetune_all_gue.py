...
dataset = ds.load_dataset("csv", data_files={"train": ['/usr/users/nigel.hartman/data/plants/finetune_all_gue.tsv']}, delimiter="\t", column_names=column_names)
...
print(m_dataset)
m_dataset.save_to_disk("/usr/users/nigel.hartman/data/plants/mapped_dataset_finetune_all_gue")
