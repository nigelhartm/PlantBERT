...
tokenizer = AutoTokenizer.from_pretrained(home+'data/'+model_type+'/vocabulary/')#vocab.json', home+'data/'+model_type+'/vocabulary/merges.txt')#,max_len=512)
...
print("Length Dataset:" + str(len_data))
