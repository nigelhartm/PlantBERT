...
for sample in range(100000, 1000000+1, 100000):
	print("start mapping tokenizer " + str(sample))
	# Load tokenizer
	print("load tokenizer")
	tokenizer = BertTokenizerFast.from_pretrained(home+'data/'+model_type+'/vocabulary_' + str(sample), max_len=128)
	...
	# save to disk
	print("save to disk")
	m_dataset.save_to_disk(home + 'data/'+ model_type +'/mapped_dataset_'+str(sample))
