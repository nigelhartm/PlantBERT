...
import os
os.environ["WANDB_PROJECT"] = "plantbert_finetune_all_gue"
...
print("load datasets")
dataset = ds.load_from_disk("/usr/users/nigel.hartman/data/plants/mapped_dataset_finetune_all_gue")
...
training_args = TrainingArguments(
	output_dir="/usr/users/nigel.hartman/data/plants/TrainingArguments_finetune_all_gue",          # output directory
...
trainer.train()
trainer.save_model("/usr/users/nigel.hartman/data/plants/model_finetune_all_gue")
...
print("Acc on test data GUE " + str(acc))

# acc on test gue
gue_dataset = ds.load_from_disk("/usr/users/nigel.hartman/data/plants/mapped_dataset_finetune_all")
...
print("Acc on test data plants " + str(gue_acc))
